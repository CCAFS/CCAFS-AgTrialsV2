...
class sfGuardUserActions extends autoSfGuardUserActions {
    ...
    public function executeChangepassword(sfWebRequest $request) {
        ...
        if (isset($newpassword) && isset($confirmnewpassword)) {
            $sf_guard_user = Doctrine::getTable('sfGuardUser')->find($id_user);
            $EmailAddress = $sf_guard_user->getEmailAddress();
            ...
            if ($EmailAddress != '') {
                ...
                $asunto = "Change Password";
                $cuerpo = "<html>";
                $cuerpo .= "<body>";
                $cuerpo .= "<h1>Change Password</h1>";
                $cuerpo .= "<p>";
                $cuerpo .= "<b>Username: </b>$username<br>";
                $cuerpo .= "<b>New password: </b>$newpassword<br>";
                $cuerpo .= "</p>";
            ...
            $this->Notice = "Your password has changed successfully in (AgTrials y AgTrials Blog).";
        }
    }
    ...
    public function executeUser(sfWebRequest $request) {
        ...
        if (isset($user_id) && isset($first_name) && isset($last_name) && isset($email_address)) {
            ...
            if (count($TbContactperson) <= 1) {
                ...
                $TbContactperson->setCnprtelephone($telephone);
            ...
            $this->Notice = "Your Information has changed successfully.";
        }
    }
