...
/**
 * TbTrialpermissiongroup filter form base class.
 *
 * @package    AgTrials
 * @subpackage filter
 ...
 */
abstract class BaseTbTrialpermissiongroupFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'id_trial'                => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('TbTrial'), 'add_empty' => true)),
      'id_grouppermission'      => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'id_grouppermission'      => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
    ...
    $this->widgetSchema->setNameFormat('tb_trialpermissiongroup_filters[%s]');
  ...
  {
    return array(
      'id_trialpermissiongroup' => 'Number',
      'id_trial'                => 'ForeignKey',
      'id_grouppermission'      => 'Number',
      'created_at'              => 'Date',
      'updated_at'              => 'Date',
      'id_user'                 => 'Number',
