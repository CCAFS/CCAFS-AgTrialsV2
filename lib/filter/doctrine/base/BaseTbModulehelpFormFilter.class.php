...
abstract class BaseTbModulehelpFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'mdhlsession'    => new sfWidgetFormFilterInput(),
      'mdhlfield'      => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'mdhlsession'    => new sfValidatorPass(array('required' => false)),
      'mdhlfield'      => new sfValidatorPass(array('required' => false)),
