...
/**
 * TbRolecontactperson filter form base class.
 *
 * @package    AgTrials
 * @subpackage filter
 ...
 */
abstract class BaseTbRolecontactpersonFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'rcpname'              => new sfWidgetFormFilterInput(),
