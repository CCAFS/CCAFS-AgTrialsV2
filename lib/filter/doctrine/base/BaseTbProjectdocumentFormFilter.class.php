...
/**
 * TbProjectdocument filter form base class.
 *
 * @package    AgTrials
 * @subpackage filter
 ...
 */
abstract class BaseTbProjectdocumentFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'id_project'         => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('TbProject'), 'add_empty' => true)),
      'prdcfile'           => new sfWidgetFormFilterInput(),
      'prdcdescription'    => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'prdcfile'           => new sfValidatorPass(array('required' => false)),
      'prdcdescription'    => new sfValidatorPass(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('tb_projectdocument_filters[%s]');
  ...
  {
    return array(
      'id_projectdocument' => 'Number',
      'id_project'         => 'ForeignKey',
      'prdcfile'           => 'Text',
      'prdcdescription'    => 'Text',
      'created_at'         => 'Date',
      'updated_at'         => 'Date',
      'id_user'            => 'Number',
