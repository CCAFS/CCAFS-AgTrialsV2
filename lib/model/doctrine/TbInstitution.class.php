...
class TbInstitution extends BaseTbInstitution {
    ...
    public function __toString() {
        $CountryName = "";
        if ($this->getIdCountry() != '') {
            $TbAdministrativedivision = Doctrine::getTable('TbAdministrativedivision')->findOneByIdAdministrativedivision($this->getIdCountry());
            $CountryName = $TbAdministrativedivision->getDmdvname();
        }
        return " {$this->getInsname()} - $CountryName";
    }
