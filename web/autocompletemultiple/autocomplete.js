...
//            }).text("x").appendTo($span);
            ...
            var $a = $("<img></img>").addClass("remove-fbautocomplete").attr({href: "", title: __title}).text("    ").appendTo($span);

            var $a = $("<img width='13' height='13' src='/images/cross.png'></img>").addClass("remove-fbautocomplete").attr({
                href: "",
                title: __title
            }).text("").appendTo($span);
