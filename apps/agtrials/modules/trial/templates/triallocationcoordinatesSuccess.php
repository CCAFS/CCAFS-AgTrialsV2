...
<script type="text/javascript">
    ...
    function getcoordenadas() {
        var inilatitudedecimal = parent.document.getElementById('trlclatitude').value;
        var inilongitudedecimal = parent.document.getElementById('trlclongitude').value;
    ...
    function enviar(lat, lon, alt) {
        parent.document.getElementById("trlclatitude").value = lat;
        parent.document.getElementById("trlclongitude").value = lon;
        parent.document.getElementById("trlcaltitude").value = document.getElementById("altitude").value;
        self.parent.tb_remove();
    }
</script>
<head>
...
<body onunload="GUnload()">
    ...
    <script type="text/javascript">
        ...
        var i_lat = parseFloat(parent.document.getElementById('trlclatitude').value);
        var i_lon = parseFloat(parent.document.getElementById('trlclongitude').value);
