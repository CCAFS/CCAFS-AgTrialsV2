            ...
            <div class="container">
                ...
                <div class="row" style="padding-top: 15px;">
                    <?php for ($a = 1; $a <= $Cursormax; $a++) { ?>
                        <div id="Downloaddatapart<?php echo $a; ?>" class=" col-sm-4 control-type-text">
                            ...
                            <div style="padding-left: 18px; font-size: 12px; font-weight: bold;" id="Downloading<?php echo $a; ?>"></div>
                        </div>
