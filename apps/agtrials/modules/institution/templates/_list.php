...
<?php else: ?>
    ...
    <table class="table table-hover">
        <thead>
            <tr>
                <?php include_partial('institution/list_th', array('sort' => $sort)) ?>
            </tr>
        </thead>
        <tfoot>
            <tr>
                <th colspan="5">
                    ...
                    <?php if ($pager->haveToPaginate()): ?>
                        <?php include_partial('institution/pagination', array('pager' => $pager)) ?>
                    <?php endif; ?>
                    <div class="btn-toolbar">
                        <?php include_partial('institution/list_batch_actions', array('helper' => $helper)) ?>
                    </div>
                </th>
            </tr>
        </tfoot>
        <tbody>
            <?php foreach ($pager->getResults() as $tb_institution): ?>
                <tr>
                    <?php include_partial('institution/list_td', array('tb_institution' => $tb_institution)) ?>
                </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
