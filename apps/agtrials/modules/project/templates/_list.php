...
<?php else: ?>
    ...
    <table class="table table-hover">
        <thead>
            <tr>
                <?php include_partial('project/list_th', array('sort' => $sort)) ?>
            </tr>
        </thead>
        <tfoot>
            <tr>
        ...
        <tbody>
            <?php foreach ($pager->getResults() as $tb_project): ?>
                <tr>
                    <?php include_partial('project/list_td', array('tb_project' => $tb_project)) ?>
                </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
