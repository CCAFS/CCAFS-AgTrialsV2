...
<div class="row">
    ...
    <div class="col-md-10 sf_admin_form" style="margin-top: 13px;">
        ...
        <form id="FormContactperson" class="form-horizontal" action="/contactperson" method="post" id="FormContactperson" name="FormContactperson" enctype="multipart/form-data">
