...
<div class="row HomePart3">
    <div class="container HomePart31">
        ...
        <div class="row HomeBoxs">   
            <div class="HomeBox" onclick="window.location.href = '/#'"> Share data and information on evaluations of agricultural technology.</div>
            <div class="HomeBox" onclick="window.location.href = '/#'"> Acquire agricultural evaluation date sets for your own research.</div>
            <div class="HomeBox" onclick="window.location.href = '/#'"> Explore the geographic dimensions of agricultural evaluation.</div>
        </div>
    </div>
</div>
...
<div class="row HomePart4">
    <div class="container">
        ...
        <div class="row HomePart41">
            <div class="LatestTrials" onclick="window.open('/trial/<?php echo $Trials[1]['id']; ?>');">  
            ...
            <div class="LatestTrials" style="margin-left: 15px;" onclick="window.open('/trial/<?php echo $Trials[2]['id']; ?>');">  
                <div class="IconTrial"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span></div>
        ...
        <div class="row HomePart41">
            <div class="LatestTrials" onclick="window.open('/trial/<?php echo $Trials[3]['id']; ?>');">  
                <div class="IconTrial"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span></div>
            ...
            <div class="LatestTrials" style="margin-left: 15px;" onclick="window.open('/trial/<?php echo $Trials[4]['id']; ?>');">  
                <div class="IconTrial"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span></div>
