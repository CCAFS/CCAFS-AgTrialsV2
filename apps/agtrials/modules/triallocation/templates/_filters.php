...
<div id="filterPopup" class="modal fade">
    <form action="<?php echo url_for('tb_triallocation_collection', array('action' => 'filter')) ?>" method="post" class="form-horizontal">
        ...
        <div class="Session" style="margin-top: 10px; margin-bottom: 10px;">
            <div class="modal-body">
                ...
                <?php foreach ($configuration->getFormFilterFields($form) as $name => $field): ?>
                    ...
                    <?php
                    include_partial('triallocation/filters_field', array(
                        'name' => $name,
        ...
        <div class="modal-footer">
            ...
            <?php echo link_to(__('<span class="glyphicon glyphicon-erase" aria-hidden="true"></span> Reset', array(), 'sf_admin'), 'tb_triallocation_collection', array('action' => 'filter'), array('query_string' => '_reset', 'method' => 'post', 'class' => 'btn btn-action')) ?>
